...
const claveToken = process.env.CLAVE_TOKEN;
...
exports.signUp = async (req, res) => {
    ...
    const { name, lastName, email, password, roleDb, birthDate, address,
...
exports.login = async(req, res) =>{
    try {
        ...
        let usrLogin = await getUserByEmail(req);
